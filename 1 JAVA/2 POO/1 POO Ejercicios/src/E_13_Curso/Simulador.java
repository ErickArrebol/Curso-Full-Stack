...
public class Simulador {
    ...
    public static void main(String[] args) {
        ...
        iniciarS.crearCurso(iniciarC);
        System.out.println("-------------------------------------------------");
        System.out.println("Curso -"+iniciarC.getNombreCurso()+"-");
        System.out.println("Alumnos "+Arrays.toString(iniciarC.getAlumnos()));
        iniciarS.calcularGananciaSemanal(iniciarC);
    }
