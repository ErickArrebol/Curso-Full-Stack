...
public class Libro implements Serializable {
    ...
    public String toString() {
        return "Libro(" + "ISBN: " + isbn + ", Titulo: " + titulo + ", AÑo: " + anio + ", Ejemplares: " + ejemplares + ", Ejemplares Prestados: " + ejemplares_prestados + ", Ejemplares Restantes: " + ejemplares_restantes + ", Disponibilidad: " + alta + ", " + autor.toString() + ", " + editorial.toString() + ')';
    }
