...
public class Simulador {
    ...
    public static void main(String[] args) {
        ...
        Armadura iniciar = new Armadura(s.nombreArmadura(), s.colores(), s.colores(), s.resitencia(), s.salud());

        System.out.println("-A R M A D U R A    A C T I V A D A-");
        System.out.println(iniciar.toString());
        System.out.println("------------------------------------");
        System.out.println("B I E N V E N I D O    S R  T O N Y ");
        System.out.println("El sistema este el linea");
        System.out.println("------------------------------------");
        int opcion = 0;
        do {
            ...
            System.out.println("4.-  Infomes del reactor");
            System.out.println("5.-  Estado de la armadura");
            System.out.println("6.-  Estado de la Bateria");
            System.out.println("7.-  Revisar Dispositivos");
            System.out.println("8.-  Reparar Dispositivos");
            System.out.println("9.-  Activar Radar");
            System.out.println("10.- Desactivar Armadura");
            try {
                opcion = leer.nextInt();
                iniciar.escribirCosonla();
                switch (opcion) {
                    case 1:
                        iniciar.caminar(1, 5);
                        break;
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        iniciar.mostrarInfoReactor();
                        break;
                    case 5:
                        iniciar.mostrarEstadoArmadura();
                        break;
                    case 6:
                        iniciar.mostrarEstadoBateria();
                        break;
                    case 7:
                        iniciar.revisarDispositivos();
                        break;
                    case 8:
                        iniciar.repararDispositivos();
                        break;
                    case 9:
                        iniciar.radarActivado();
                        break;
                    case 10:
                        System.out.println("A R M A D U R A   D E S A C T I V A D A");
                        break;
                    default:
